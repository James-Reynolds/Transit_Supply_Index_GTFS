...
Melbourne is INSERT DESCRIPTION OF MELBOURNE HERE
...
Minor corrections were made to the GTFS files to remove duplicate stop_ids. These involved minor discrepancies in either the stop name, latitude or longitude. 


The Australian Bureau of Statistics (ABS) provides a range of shape files and other resources, and this study made use of the absmapsdata R package [@R-absmapsdata] to access the 2021 Local Government Area (LGA) boundaries for the Greater Melbourne area.  The EPSG:28355 transform [@EPSG_28355] was used to shift longitude and latitude into metres as per the Geocentric Datum of Australia 1994 (GDA95 / MGA zone 55) coordinates. 
