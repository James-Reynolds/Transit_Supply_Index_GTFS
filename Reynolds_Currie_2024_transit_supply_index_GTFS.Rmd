...
```{r Victoria_IRSAD_load_2021, echo=FALSE, warning=FALSE, message=FALSE, fig.fullwidth = TRUE, fig.cap= "2021 IRSAD for SA1s within the Clayton SA2 boundary: score (left) and percentile within Victoria (right)", fig.show="hold", out.width="50%"}
...
IRSAD_2021_sa12016$IRSAD_score <- IRSAD_2021_sa12021$IRSAD_score / IRSAD_2021_sa12021$RATIO_FROM_TO
