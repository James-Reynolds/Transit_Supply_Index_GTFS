...
The gtfstools R package [@R-gtfstools] was used to split input GTFS feeds by mode to facilitate the buffer zone calculation.  Default buffer zones of 400 metres (bus and Light Rail Transit (LRT)) and 800 metres (rail, monorail, ) and the extended GTFS mode definitions based on @filter_GTFS_by_mode were used (and can be edited in the buffer_zones.csv file)
