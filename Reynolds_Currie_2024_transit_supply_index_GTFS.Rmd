...
```{r Melbourne_2019_october, echo=FALSE, warning=FALSE, message=FALSE}
victoria_2019 <- gtfstools::read_gtfs("data/Melbourne/2019/191011/gtfs.zip")

##resolve route colour problem in gtfs file
victoria_2019$routes$route_color <- 0
...
##write to csv
write_csv(victoria_2019_SI_df_by_mode, "c:/Users/rjulian/Documents/Transit_Supply_Index_GTFS/results/Victoria_2019_SI_df_by_mode_SA12016_191013.csv")
...
##write to csv
write_csv(victoria_2019_SI_df_by_mode, "c:/Users/rjulian/Documents/Transit_Supply_Index_GTFS/results/Victoria_2019_SI_df_by_mode_SA12016_191015.csv")
...
The results, as processed, have been stored in Comma Separated Variable (CSV) files. Unfortunately, however, these files were saved according to the European numeric approach, with decimal points represented by commas and variables separated by semicolons.  This file format is fine to use with R, but can lead to problems when opening in Excel or other programs. Therefore, the data is loaded from the (original) CSV files, but new CSV files have been also been created (accessible in the results_non_eu folder) according to the typical Australian/US approach of using a full stop to separate the decimals in numeric records. 

```{r save_as_csv_non_EU, echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE}

#write.csv(victoria_2016_SI_df_by_mode, "results_non_eu/Victoria_2016_SI_df_by_mode_SA12016_160809.csv")
#write.csv(victoria_2016_SI_total, "results_non_eu/Victoria_2016_SI_SA12016_160809.csv")

#write.csv(victoria_2021_SI_df_by_mode, "results_non_eu/Victoria_2021_SI_df_by_mode_SA12016_210810.csv")
#write.csv(victoria_2021_SI_total, "results_non_eu/Victoria_2021_SI_SA12016_210810.csv")
