...
```{r Victoria_IRSAD_compare, echo=FALSE, warning=FALSE, message=FALSE, fig.fullwidth = TRUE, fig.cap= "Comparing 2016 and 2021 IRSAD scores for Victorian LGAs"}
...
IRSAD_2016_2021_lga_wider <- pivot_wider(IRSAD_2016_2021_lga %>% filter(state_name_2021 == "Victoria") %>% select("lga_code_2021", "lga_name_2021", "IRSAD_score", "Census"), names_from = "Census", values_from = "IRSAD_score")
