...
#victoria_2018_SI_df_by_mode <- read.csv("victoria_2018_SI_df_by_mode_20210810.csv")
...
#load pre-calculated df by mode (for just one day)
#victoria_2019_SI_df_by_mode <- read.csv("victoria_2019_SI_df_by_mode_20210810.csv")
...
#load pre-calculated df by mode (for just one day)
#victoria_2020_SI_df_by_mode <- read.csv("victoria_2020_SI_df_by_mode_20210810.csv")
...
#load pre-calculated df by mode (for just one day)
#victoria_2022_SI_df_by_mode <- read.csv("victoria_2022_SI_df_by_mode_20210810.csv")
...
victoria_2023 <- read_gtfs("data/Melbourne/2018/180813/gtfs.zip")
...
#load pre-calculated df by mode (for just one day)
#victoria_2023_SI_df_by_mode <- read.csv("victoria_2023_SI_df_by_mode_20210810.csv")
